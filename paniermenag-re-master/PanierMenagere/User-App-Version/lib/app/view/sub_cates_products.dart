...
class SubCatesProductScreen extends StatefulWidget {
  const SubCatesProductScreen({super.key});
                                                  ...
                                                  title: product.variations?[0].items?[index].discount > 0
                                                      ...
                                                      : Get.find<SubCatesProductsController>().currencySide == 'left'
                                                          ? Row(
                                                              ...
                                                              children: [
                                                                Text(
                                                                  product.variations?[0].items?[index].title + ' - ' + Get.find<SubCatesProductsController>().currencySymbol + product.variations?[0].items?[index].price.toString(),
                                                          ...
                                                          : Row(
                                                              ...
                                                              children: [
                                                                Text(
                                                                  product.variations?[0].items?[index].title + ' - ' + product.variations?[0].items?[index].price.toString() + Get.find<SubCatesProductsController>().currencySymbol,
                                                                  textAlign: TextAlign.start,
                                                                  style: const TextStyle(fontSize: 10),
                                                                )
                                                              ],
                                      ...
                                      ? Row(
                                          ...
                                          children: [
                                            ...
                                            Text(Get.find<SubCatesProductsController>().currencySymbol + product.variations![0].items![product.variant].price.toString(),
                                                style: const TextStyle(fontSize: 10, fontFamily: 'regular', decoration: TextDecoration.lineThrough)),
                                            Text(Get.find<SubCatesProductsController>().currencySymbol + product.variations![0].items![product.variant].discount.toString(), style: const TextStyle(fontFamily: 'bold', fontSize: 10))
                                          ],
                                        )
                                      : Row(
                                          crossAxisAlignment: CrossAxisAlignment.center,
                                          ...
                                          children: [
                                            ...
                                            Text(product.variations![0].items![product.variant].price.toString() + Get.find<SubCatesProductsController>().currencySymbol,
                                                style: const TextStyle(fontSize: 10, fontFamily: 'regular', decoration: TextDecoration.lineThrough)),
                                            Text(product.variations![0].items![product.variant].discount.toString() + Get.find<SubCatesProductsController>().currencySymbol, style: const TextStyle(fontFamily: 'bold', fontSize: 10))
                                          ],
                                        )
                                  : Get.find<SubCatesProductsController>().currencySide == 'left'
                                      ? Row(
                                          ...
                                          children: [
                                            Text(
                                              product.variations?[0].items?[product.variant].title + ' - ' + Get.find<SubCatesProductsController>().currencySymbol + product.variations?[0].items?[product.variant].price.toString(),
                                              textAlign: TextAlign.center,
                                              style: const TextStyle(fontSize: 10),
                                            )
                                          ],
                                      ...
                                      : Row(
                                          ...
                                          children: [
                                            Text(
                                              product.variations?[0].items?[product.variant].title + ' - ' + product.variations?[0].items?[product.variant].price.toString() + Get.find<SubCatesProductsController>().currencySymbol,
                                              textAlign: TextAlign.center,
                                              style: const TextStyle(fontSize: 10),
                                            )
                                          ],
