                                                  ...
                                                  title: product.variations?[0].items?[index].discount > 0
                                                      ...
                                                      : Get.find<PopularController>().currencySide == 'left'
                                                          ? Row(
                                                              ...
                                                              children: [
                                                                Text(
                                                                  product.variations?[0].items?[index].title + ' - ' + Get.find<PopularController>().currencySymbol + product.variations?[0].items?[index].price.toString(),
                                                          ...
                                                          : Row(
                                                              ...
                                                              children: [
                                                                Text(
                                                                  product.variations?[0].items?[index].title + ' - ' + product.variations?[0].items?[index].price.toString() + Get.find<PopularController>().currencySymbol,
                                                                  textAlign: TextAlign.start,
                                                                  style: const TextStyle(fontSize: 10),
                                                                )
                                                              ],
                                      ...
                                      ? Row(
                                          ...
                                          children: [
                                            ...
                                            Text(Get.find<PopularController>().currencySymbol + product.variations![0].items![product.variant].price.toString(),
                                                style: const TextStyle(fontSize: 10, fontFamily: 'regular', decoration: TextDecoration.lineThrough)),
                                            Text(Get.find<PopularController>().currencySymbol + product.variations![0].items![product.variant].discount.toString(), style: const TextStyle(fontFamily: 'bold', fontSize: 10))
                                          ],
                                        )
                                      : Row(
                                          crossAxisAlignment: CrossAxisAlignment.center,
                                          ...
                                          children: [
                                            ...
                                            Text(product.variations![0].items![product.variant].price.toString() + Get.find<PopularController>().currencySymbol,
                                                style: const TextStyle(fontSize: 10, fontFamily: 'regular', decoration: TextDecoration.lineThrough)),
                                            Text(product.variations![0].items![product.variant].discount.toString() + Get.find<PopularController>().currencySymbol, style: const TextStyle(fontFamily: 'bold', fontSize: 10))
                                          ],
                                        )
                                  : Get.find<PopularController>().currencySide == 'left'
                                      ? Row(
                                          ...
                                          children: [
                                            Text(
                                              product.variations?[0].items?[product.variant].title + ' - ' + Get.find<PopularController>().currencySymbol + product.variations?[0].items?[product.variant].price.toString(),
                                              textAlign: TextAlign.center,
                                              style: const TextStyle(fontSize: 10),
                                            )
                                          ],
                                      ...
                                      : Row(
                                          ...
                                          children: [
                                            Text(
                                              product.variations?[0].items?[product.variant].title + ' - ' + product.variations?[0].items?[product.variant].price.toString() + Get.find<PopularController>().currencySymbol,
                                              textAlign: TextAlign.center,
                                              style: const TextStyle(fontSize: 10),
                                            )
                                          ],
                              ...
                              Expanded(
                                child: product.discount > 0
                                    ? Row(
                                        children: [
                                          Get.find<PopularController>().currencySide == 'left'
                                              ? Text('${Get.find<PopularController>().currencySymbol}${product.originalPrice}', style: const TextStyle(fontSize: 14, fontFamily: 'regular', decoration: TextDecoration.lineThrough))
                                              : Text('${product.originalPrice}${Get.find<PopularController>().currencySymbol}', style: const TextStyle(fontSize: 14, fontFamily: 'regular', decoration: TextDecoration.lineThrough)),
                                          Get.find<PopularController>().currencySide == 'left'
                                              ? Text('${Get.find<PopularController>().currencySymbol}${product.sellPrice}', style: const TextStyle(fontSize: 16, fontFamily: 'medium'))
                                              : Text('${product.sellPrice}${Get.find<PopularController>().currencySymbol}', style: const TextStyle(fontSize: 16, fontFamily: 'medium')),
                                        ],
                                                ...
                                                ? Get.find<PopularController>().currencySide == 'left'
                                                    ? Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          Text(Get.find<PopularController>().currencySymbol + product.variations![0].items![index].price.toString(),
                                                              style: const TextStyle(fontSize: 10, fontFamily: 'regular', decoration: TextDecoration.lineThrough)),
                                                          Text(Get.find<PopularController>().currencySymbol + product.variations![0].items![index].discount.toString(), style: const TextStyle(fontFamily: 'bold', fontSize: 10))
                                                        ],
                                                      )
                                                    : Row(
                                                        crossAxisAlignment: CrossAxisAlignment.start,
                                                        ...
                                                        children: [
                                                          ...
                                                          Text(product.variations![0].items![index].price.toString() + Get.find<PopularController>().currencySymbol,
                                                              style: const TextStyle(fontSize: 10, fontFamily: 'regular', decoration: TextDecoration.lineThrough)),
                                                          Text(product.variations![0].items![index].discount.toString() + Get.find<PopularController>().currencySymbol, style: const TextStyle(fontFamily: 'bold', fontSize: 10))
                                                        ],
                                                      )
                                                : Get.find<PopularController>().currencySide == 'left'
                                                    ? Row(
