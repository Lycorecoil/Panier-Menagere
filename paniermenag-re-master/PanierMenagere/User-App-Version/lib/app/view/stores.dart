...
class _StoresScreenState extends State<StoresScreen> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<StoresController>(
      builder: (value) {
        return Scaffold(
          appBar: AppBar(title: const Text('Top Stores', style: ThemeProvider.titleStyle), backgroundColor: ThemeProvider.appColor, automaticallyImplyLeading: true, elevation: 0.0, centerTitle: false),
