                          ...
                          trailing: Wrap(
                            ...
                            children: <Widget>[
                              GestureDetector(
                                onTap: () {
                                  Get.delete<AddNewAddressController>(force: true);
                                  Get.toNamed(AppRouter.getNewAddressRoutes(),
                                      arguments: ['newAddress', 'edit', item.id.toString(), item.address.toString(), item.house.toString(), item.landmark.toString(), item.pincode.toString(), item.title.toString()]);
                                },
