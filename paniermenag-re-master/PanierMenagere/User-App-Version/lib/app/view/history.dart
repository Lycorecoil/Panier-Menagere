                                                                    ...
                                                                    Row(
                                                                      children: value.ordersList[index].orders![orderIndex].variations == null
                                                                          ...
                                                                          : [
                                                                              ...
                                                                              const Text(' - '),
                                                                              Text(value.ordersList[index].orders![orderIndex].variations![0].items![value.ordersList[index].orders![orderIndex].variant].title.toString(),
                                                                                  style: const TextStyle(fontSize: 10, fontFamily: 'regular')),
                                                                              const Text(' - '),
                                                                              value.ordersList[index].orders![orderIndex].variations![0].items![value.ordersList[index].orders![orderIndex].variant].discount! > 0
                                                                                  ? value.currencySide == 'left'
                                                                                      ? Text(
                                                                                          value.currencySymbol +
                                                                                              value.ordersList[index].orders![orderIndex].variations![0].items![value.ordersList[index].orders![orderIndex].variant].discount
                                                                                                  .toString(),
                                                                                          style: const TextStyle(fontSize: 10, fontFamily: 'regular'))
                                                                                      : Text(
                                                                                          value.ordersList[index].orders![orderIndex].variations![0].items![value.ordersList[index].orders![orderIndex].variant].discount.toString() +
                                                                                              value.currencySymbol,
                                                                                          style: const TextStyle(fontSize: 10, fontFamily: 'regular'))
                                                                                  : value.currencySide == 'left'
                                                                                      ? Text(
                                                                                          value.currencySymbol +
                                                                                              value.ordersList[index].orders![orderIndex].variations![0].items![value.ordersList[index].orders![orderIndex].variant].price.toString(),
                                                                                          style: const TextStyle(fontSize: 10, fontFamily: 'regular'))
                                                                                      : Text(
                                                                                          value.ordersList[index].orders![orderIndex].variations![0].items![value.ordersList[index].orders![orderIndex].variant].price.toString() +
                                                                                              value.currencySymbol,
                                                          ...
                                                          Container(
                                                            ...
                                                            child: Row(
                                                              ...
                                                              children: <Widget>[
                                                                ...
                                                                value.currencySide == 'left'
                                                                    ? Text(value.currencySymbol + value.ordersList[index].grandTotal.toString(), style: const TextStyle(fontSize: 10, fontFamily: 'bold'))
                                                                    : Text(value.ordersList[index].grandTotal.toString() + value.currencySymbol, style: const TextStyle(fontSize: 10, fontFamily: 'bold'))
                                                              ],
                                                            ),
                                                          ),
