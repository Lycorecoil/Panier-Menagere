                                                          ...
                                                          children: [
                                                            Get.find<ProductController>().currencySide == 'left'
                                                                ...
                                                                : Text('${value.details.originalPrice}${Get.find<ProductController>().currencySymbol}',
                                                                    style: const TextStyle(fontSize: 14, fontFamily: 'regular', decoration: TextDecoration.lineThrough)),
                                                            Get.find<ProductController>().currencySide == 'left'
                                                                ? Text('${Get.find<ProductController>().currencySymbol}${value.details.sellPrice}', style: const TextStyle(fontSize: 16, fontFamily: 'medium'))
                                                                : Text('${value.details.sellPrice}${Get.find<ProductController>().currencySymbol}', style: const TextStyle(fontSize: 16, fontFamily: 'medium')),
                                                          ],
                                                        )
                                                      : Row(
                                                          children: [
                                                            Get.find<ProductController>().currencySide == 'left'
                                                                ? Text('${Get.find<ProductController>().currencySymbol}${value.details.originalPrice}', style: const TextStyle(fontSize: 16, fontFamily: 'medium'))
                                                                : Text('${value.details.originalPrice}${Get.find<ProductController>().currencySymbol}', style: const TextStyle(fontSize: 16, fontFamily: 'medium'))
                                                          ],
                                                        ),
                                                ),
                                              ],
                                                                ...
                                                                title: value.details.variations![0].items![index].discount! > 0
                                                                    ? Get.find<ProductController>().currencySide == 'left'
                                                                        ? Row(
                                                                            ...
                                                                            mainAxisAlignment: MainAxisAlignment.start,
                                                                            children: [
                                                                              Text('${value.details.variations![0].items![index].title!} - ', textAlign: TextAlign.start, style: const TextStyle(fontSize: 10)),
                                            ...
                                            child: value.details.variations![0].items![value.details.variant].discount! > 0
                                                ? Get.find<ProductController>().currencySide == 'left'
                                                    ? Row(
                                                        ...
                                                        children: [
                                                          Text('${value.details.variations![0].items![value.details.variant].title!} - ', textAlign: TextAlign.center, style: const TextStyle(fontSize: 10)),
                              ...
                              Expanded(
                                child: product.discount > 0
                                    ? Row(
                                        children: [
                                          Get.find<ProductController>().currencySide == 'left'
                                              ? Text('${Get.find<ProductController>().currencySymbol}${product.originalPrice}', style: const TextStyle(fontSize: 14, fontFamily: 'regular', decoration: TextDecoration.lineThrough))
                                              : Text('${product.originalPrice}${Get.find<ProductController>().currencySymbol}', style: const TextStyle(fontSize: 14, fontFamily: 'regular', decoration: TextDecoration.lineThrough)),
                                          Get.find<ProductController>().currencySide == 'left'
                                            ...
                                            title: product.variations?[0].items?[index].discount > 0
                                                ...
                                                : Get.find<ProductController>().currencySide == 'left'
                                                    ? Row(
                                                        ...
                                                        children: [
                                                          Text(
                                                            product.variations?[0].items?[index].title + ' - ' + Get.find<ProductController>().currencySymbol + product.variations?[0].items?[index].price.toString(),
                                                            textAlign: TextAlign.start,
                                                            style: const TextStyle(fontSize: 10),
                                                          )
                                                        ],
                                                    ...
                                                    : Row(
                                                        ...
                                                        children: [
                                                          Text(
                                                            product.variations?[0].items?[index].title + ' - ' + product.variations?[0].items?[index].price.toString() + Get.find<ProductController>().currencySymbol,
                                                            textAlign: TextAlign.start,
                                                            style: const TextStyle(fontSize: 10),
                                                          )
                                                        ],
                                ...
                                ? Row(
                                    ...
                                    children: [
                                      ...
                                      Text(Get.find<ProductController>().currencySymbol + product.variations![0].items![product.variant].price.toString(),
                                          style: const TextStyle(fontSize: 10, fontFamily: 'regular', decoration: TextDecoration.lineThrough)),
                                      Text(Get.find<ProductController>().currencySymbol + product.variations![0].items![product.variant].discount.toString(), style: const TextStyle(fontFamily: 'bold', fontSize: 10))
                                    ],
                                  )
                                : Row(
                                    crossAxisAlignment: CrossAxisAlignment.center,
                                    ...
                                    children: [
                                      ...
                                      Text(product.variations![0].items![product.variant].price.toString() + Get.find<ProductController>().currencySymbol,
                                          style: const TextStyle(fontSize: 10, fontFamily: 'regular', decoration: TextDecoration.lineThrough)),
                                      Text(product.variations![0].items![product.variant].discount.toString() + Get.find<ProductController>().currencySymbol, style: const TextStyle(fontFamily: 'bold', fontSize: 10))
                                    ],
                                  )
                            : Get.find<ProductController>().currencySide == 'left'
                                ? Row(
                                    ...
                                    children: [
                                      Text(
                                        product.variations?[0].items?[product.variant].title + ' - ' + Get.find<ProductController>().currencySymbol + product.variations?[0].items?[product.variant].price.toString(),
                                        textAlign: TextAlign.center,
                                        style: const TextStyle(fontSize: 10),
                                      )
                                    ],
                                ...
                                : Row(
                                    ...
                                    children: [
                                      Text(
                                        product.variations?[0].items?[product.variant].title + ' - ' + product.variations?[0].items?[product.variant].price.toString() + Get.find<ProductController>().currencySymbol,
                                        textAlign: TextAlign.center,
                                        style: const TextStyle(fontSize: 10),
                                      )
                                    ],
