                                                  ...
                                                  title: product.variations?[0].items?[index].discount > 0
                                                      ...
                                                      : Get.find<CartController>().currencySide == 'left'
                                                          ? Row(
                                                              ...
                                                              children: [
                                                                Text(
                                                                  product.variations?[0].items?[index].title + ' - ' + Get.find<CartController>().currencySymbol + product.variations?[0].items?[index].price.toString(),
                                                          ...
                                                          : Row(
                                                              ...
                                                              children: [
                                                                Text(
                                                                  product.variations?[0].items?[index].title + ' - ' + product.variations?[0].items?[index].price.toString() + Get.find<CartController>().currencySymbol,
                                                                  textAlign: TextAlign.start,
                                                                  style: const TextStyle(fontSize: 10),
                                                                )
                                                              ],
                              ...
                              child: product.variations?[0].items?[product.variant].discount > 0
                                  ...
                                  : Get.find<CartController>().currencySide == 'left'
                                      ? Row(
                                          ...
                                          mainAxisAlignment: MainAxisAlignment.center,
                                          children: [
                                            Text(product.variations?[0].items?[product.variant].title + ' - ' + Get.find<CartController>().currencySymbol + product.variations?[0].items?[product.variant].price.toString(),
                                      ...
                                      : Row(
                                          ...
                                          mainAxisAlignment: MainAxisAlignment.center,
                                          children: [
                                            Text(product.variations?[0].items?[product.variant].title + ' - ' + product.variations?[0].items?[product.variant].price.toString() + Get.find<CartController>().currencySymbol,
                                                textAlign: TextAlign.center, style: const TextStyle(fontSize: 10))
                                          ],
                                        ),
                            ),
