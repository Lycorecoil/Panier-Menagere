                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                                              ...
                                              children: value.orderDetails[index].order![orderIndex].variations == null
                                                  ? [
                                                      ...
                                                      if (value.orderDetails[index].order![orderIndex].haveGram == 1)
                                                        Text(value.orderDetails[index].order![orderIndex].gram.toString() + ' grams'.tr, style: const TextStyle(fontSize: 10, fontFamily: 'regular'), textAlign: TextAlign.start)
                                                      else if (value.orderDetails[index].order![orderIndex].haveKg == 1)
                                                        Text(value.orderDetails[index].order![orderIndex].kg.toString() + ' kg'.tr, style: const TextStyle(fontSize: 10, fontFamily: 'regular'), textAlign: TextAlign.start)
                                                      else if (value.orderDetails[index].order![orderIndex].haveLiter == 1)
                                                        Text(value.orderDetails[index].order![orderIndex].liter.toString() + ' ltr'.tr, style: const TextStyle(fontSize: 10, fontFamily: 'regular'), textAlign: TextAlign.start)
                                                      else if (value.orderDetails[index].order![orderIndex].haveMl == 1)
                                                        Text(value.orderDetails[index].order![orderIndex].ml.toString() + ' ml'.tr, style: const TextStyle(fontSize: 10, fontFamily: 'regular'), textAlign: TextAlign.start)
                                                      else if (value.orderDetails[index].order![orderIndex].havePcs == 1)
                                                        Text(value.orderDetails[index].order![orderIndex].pcs.toString() + ' pcs'.tr, style: const TextStyle(fontSize: 10, fontFamily: 'regular'), textAlign: TextAlign.start),
                                                      const Text(' - '),
                                                      value.orderDetails[index].order![orderIndex].discount! > 0
                                                          ? value.currencySide == 'left'
                                                              ? Text(value.currencySymbol + value.orderDetails[index].order![orderIndex].discount.toString(), style: const TextStyle(fontSize: 10, fontFamily: 'regular'))
                                                              : Text(value.orderDetails[index].order![orderIndex].discount.toString() + value.currencySymbol, style: const TextStyle(fontSize: 10, fontFamily: 'regular'))
                                                          : value.currencySide == 'left'
                                                              ? Text(value.currencySymbol + value.orderDetails[index].order![orderIndex].originalPrice.toString(), style: const TextStyle(fontSize: 10, fontFamily: 'regular'))
                                                              : Text(value.orderDetails[index].order![orderIndex].originalPrice.toString() + value.currencySymbol, style: const TextStyle(fontSize: 10, fontFamily: 'regular'))
                                                    ]
                                                  : [
                                                      Text(
                                                        value.orderDetails[index].order![orderIndex].name!.length > 25
                                                      ...
                                                      value.orderDetails[index].order![orderIndex].variations![0].items![value.orderDetails[index].order![orderIndex].variant].discount! > 0
                                                          ? value.currencySide == 'left'
                                                              ? Text(
                                                                  value.currencySymbol + value.orderDetails[index].order![orderIndex].variations![0].items![value.orderDetails[index].order![orderIndex].variant].discount.toString(),
                                                                  style: const TextStyle(fontSize: 10, fontFamily: 'regular'))
                                                              : Text(
                                                                  value.orderDetails[index].order![orderIndex].variations![0].items![value.orderDetails[index].order![orderIndex].variant].discount.toString() + value.currencySymbol,
                                                                  style: const TextStyle(fontSize: 10, fontFamily: 'regular'))
                                                          : value.currencySide == 'left'
                                                              ? Text(value.currencySymbol + value.orderDetails[index].order![orderIndex].variations![0].items![value.orderDetails[index].order![orderIndex].variant].price.toString(),
                                                                  style: const TextStyle(fontSize: 10, fontFamily: 'regular'))
                                                              : Text(value.orderDetails[index].order![orderIndex].variations![0].items![value.orderDetails[index].order![orderIndex].variant].price.toString() + value.currencySymbol,
                                                                  style: const TextStyle(fontSize: 10, fontFamily: 'regular'))
                                                    ],
                                            ),
                        ...
                        Container(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: <Widget>[Text('Deliver to'.tr, style: const TextStyle(fontFamily: 'bold', fontSize: 12)), Text(value.details.orderTo.toString().toUpperCase(), style: const TextStyle(fontFamily: 'bold'))],
                          ),
                        ),
