...
class OrderDetailsController extends GetxController implements GetxService {
  ...
  Future<void> getOrderDetails() async {
    ...
    if (response.statusCode == 200) {
      ...
      datas.dateTime = Jiffy.parse(datas.dateTime.toString()).yMMMMEEEEdjm;
      _details = datas;
      ...
      for (var data in storeIds) {
        ...
        if (details.orderTo == 'home' && details.deliveryCharge! > 0) {
                                      ...
                                      children: orderDetails[index].order![orderIndex].variations == null
                                          ? [
                                              ...
                                              orderDetails[index].order![orderIndex].discount! > 0
                                                  ...
                                                  : currencySide == 'left'
                                                      ? Text(currencySymbol + orderDetails[index].order![orderIndex].originalPrice.toString(), style: const TextStyle(fontSize: 10, fontFamily: 'regular'))
                                                      : Text(orderDetails[index].order![orderIndex].originalPrice.toString() + currencySymbol, style: const TextStyle(fontSize: 10, fontFamily: 'regular'))
                                            ]
                                          : [
                                              Text(
                                                orderDetails[index].order![orderIndex].name.toString(),
                                              ...
                                              orderDetails[index].order![orderIndex].variations![0].items![orderDetails[index].order![orderIndex].variant].discount! > 0
                                                  ? currencySide == 'left'
                                                      ? Text(currencySymbol + orderDetails[index].order![orderIndex].variations![0].items![orderDetails[index].order![orderIndex].variant].discount.toString(),
                                                          style: const TextStyle(fontSize: 10, fontFamily: 'regular'))
                                                      : Text(orderDetails[index].order![orderIndex].variations![0].items![orderDetails[index].order![orderIndex].variant].discount.toString() + currencySymbol,
                                                          style: const TextStyle(fontSize: 10, fontFamily: 'regular'))
                                                  : currencySide == 'left'
                                                      ? Text(currencySymbol + orderDetails[index].order![orderIndex].variations![0].items![orderDetails[index].order![orderIndex].variant].price.toString(),
                                                          style: const TextStyle(fontSize: 10, fontFamily: 'regular'))
                                                      : Text(orderDetails[index].order![orderIndex].variations![0].items![orderDetails[index].order![orderIndex].variant].price.toString() + currencySymbol,
                                                          style: const TextStyle(fontSize: 10, fontFamily: 'regular'))
                                            ],
                                    ),
  ...
  Future<void> updateOrderStatus() async {
    var orderNotesParam = {'status': 1, 'value': 'Order cancelled by you', 'time': Jiffy.now().format(pattern: 'MMMM do yyyy, h:mm:ss a')};
