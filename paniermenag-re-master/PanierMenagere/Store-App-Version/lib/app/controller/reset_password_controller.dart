...
class ResetPasswordController extends GetxController implements GetxService {
  ...
  Future<void> onOtpSubmit(context) async {
    isLogin.value = !isLogin.value;
    update();
    var param = {'id': smsId, 'otp': otpCode, 'type': resetWith == 0 ? 'email' : 'phone', 'email': emailReset.text, 'country_code': countryCode != '' ? countryCode : 'NA', 'mobile': phoneReset.text != '' ? phoneReset.text : 'NA'};
