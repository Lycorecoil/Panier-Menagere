...
class ChatConversionModel {
  ...
  ChatConversionModel({this.senderFirstName, this.uid, this.receiverName, this.participants, this.senderLastName, this.senderCover, this.receiverLastName, this.receiverCover, this.senderType, this.receiverType});
