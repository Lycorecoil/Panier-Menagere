...
class GeneralModel {
  ...
  GeneralModel({this.id, this.name, this.mobile, this.email, this.address, this.city, this.state, this.zip, this.country, this.min, this.free, this.tax, this.shipping, this.shippingPrice, this.status, this.extraField});
