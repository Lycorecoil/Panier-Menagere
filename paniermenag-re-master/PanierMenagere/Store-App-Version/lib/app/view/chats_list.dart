                        ...
                        (index) {
                          return value.chatList[index].uid.toString() == value.uid
                              ? Container(
                                  ...
                                  child: InkWell(
                                    onTap: () =>
                                        value.onChat(value.chatList[index].participants.toString(), '${value.chatList[index].receiverName} ${value.chatList[index].receiverLastName} ( ${value.chatList[index].receiverType} )'),
                                    child: Row(
                                      children: [
                                        SizedBox(
                                          height: 30,
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Row(
                                                  ...
                                                  children: [Text('${value.chatList[index].receiverName} ${value.chatList[index].receiverLastName}', style: const TextStyle(fontFamily: 'medium')), const Icon(Icons.chevron_right)],
                                                ),
                                              ],
                                            ),
                                          ),
                              ...
                              : Container(
                                  ...
                                  padding: const EdgeInsets.symmetric(vertical: 5),
                                  child: InkWell(
                                    onTap: () => value.onChat(value.chatList[index].uid.toString(), '${value.chatList[index].senderFirstName} ${value.chatList[index].senderLastName} ( ${value.chatList[index].senderType} )'),
                                    child: Row(
                                      children: [
                                        SizedBox(
                                          height: 30,
                                          ...
                                          child: Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Row(
                                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                  children: [Text('${value.chatList[index].senderFirstName} ${value.chatList[index].senderLastName}', style: const TextStyle(fontFamily: 'medium')), const Icon(Icons.chevron_right)],
                                                ),
                                              ],
                                            ),
                                          ),
