class GoogleDirectionResponseModel {
  List<GeocodedWaypoints>? geocodedWaypoints;
  List<Routes>? routes;
  String? status;

  GoogleDirectionResponseModel({this.geocodedWaypoints, this.routes, this.status});

  GoogleDirectionResponseModel.fromJson(Map<String, dynamic> json) {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (geocodedWaypoints != null) {
      data['geocoded_waypoints'] = geocodedWaypoints!.map((v) => v.toJson()).toList();
    }
    if (routes != null) {
...
class Routes {
  ...
  String? copyrights;
  List<Legs>? legs;
  PolylineConfigModel? overviewPolyline;
  String? summary;

  Routes({this.bounds, this.copyrights, this.legs, this.overviewPolyline, this.summary});
  ...
  Routes.fromJson(Map<String, dynamic> json) {
    ...
    overviewPolyline = json['overview_polyline'] != null ? PolylineConfigModel.fromJson(json['overview_polyline']) : null;
...
class Bounds {
  ...
  Bounds.fromJson(Map<String, dynamic> json) {
    ...
    southwest = json['southwest'] != null ? Northeast.fromJson(json['southwest']) : null;
  }
...
class Legs {
  ...
  Legs({this.distance, this.duration, this.endAddress, this.endLocation, this.startAddress, this.startLocation, this.steps});
...
class Steps {
  ...
  PolylineConfigModel? polyline;
  Northeast? startLocation;
  String? travelMode;
  String? maneuver;

  Steps({this.distance, this.duration, this.endLocation, this.htmlInstructions, this.polyline, this.startLocation, this.travelMode, this.maneuver});
  ...
  Steps.fromJson(Map<String, dynamic> json) {
    ...
    polyline = json['polyline'] != null ? PolylineConfigModel.fromJson(json['polyline']) : null;
    startLocation = json['start_location'] != null ? Northeast.fromJson(json['start_location']) : null;
...
class PolylineConfigModel {
  String? points;

  PolylineConfigModel({this.points});

  PolylineConfigModel.fromJson(Map<String, dynamic> json) {
    points = json['points'];
  }
