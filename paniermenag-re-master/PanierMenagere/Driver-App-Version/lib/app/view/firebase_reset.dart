...
class _FirebaseResetScreenState extends State<FirebaseResetScreen> {
  ...
  void initState() {
    ...
    controller
      ...
      ..loadRequest(Uri.parse('${Get.find<FirebaseResetController>().apiURL}${AppConstants.openFirebaseVerification}mobile=${Get.find<FirebaseResetController>().countryCode}${Get.find<FirebaseResetController>().phoneNumber}'));
