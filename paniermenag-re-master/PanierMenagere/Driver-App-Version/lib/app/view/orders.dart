                                                        ...
                                                        children: value.newOrderList[index].orders![orderIndex].variations == null
                                                            ? [
                                                                ...
                                                                if (value.newOrderList[index].orders![orderIndex].haveGram == 1)
                                                                  Text('${value.newOrderList[index].orders![orderIndex].gram} ${'grams'.tr}', style: const TextStyle(fontSize: 10, fontFamily: 'regular'), textAlign: TextAlign.start)
                                                                else if (value.newOrderList[index].orders![orderIndex].haveKg == 1)
                                                                  Text('${value.newOrderList[index].orders![orderIndex].kg} ${'kg'.tr}', style: const TextStyle(fontSize: 10, fontFamily: 'regular'), textAlign: TextAlign.start)
                                                                else if (value.newOrderList[index].orders![orderIndex].haveLiter == 1)
                                                                  Text('${value.newOrderList[index].orders![orderIndex].liter} ${'ltr'.tr}', style: const TextStyle(fontSize: 10, fontFamily: 'regular'), textAlign: TextAlign.start)
                                                                else if (value.newOrderList[index].orders![orderIndex].haveMl == 1)
                                                                  Text('${value.newOrderList[index].orders![orderIndex].ml} ${'ml'.tr}', style: const TextStyle(fontSize: 10, fontFamily: 'regular'), textAlign: TextAlign.start)
                                                                else if (value.newOrderList[index].orders![orderIndex].havePcs == 1)
                                                                  Text('${value.newOrderList[index].orders![orderIndex].pcs} ${'pcs'.tr}', style: const TextStyle(fontSize: 10, fontFamily: 'regular'), textAlign: TextAlign.start),
                                                                const Text(' - '),
                                                                value.newOrderList[index].orders![orderIndex].discount! > 0
                                                                    ? value.currencySide == 'left'
                                                                        ? Text(value.currencySymbol + value.newOrderList[index].orders![orderIndex].discount.toString(), style: const TextStyle(fontSize: 10, fontFamily: 'regular'))
                                                                        : Text(value.newOrderList[index].orders![orderIndex].discount.toString() + value.currencySymbol, style: const TextStyle(fontSize: 10, fontFamily: 'regular'))
                                                                    : value.currencySide == 'left'
                                                            ...
                                                            : [
                                                                ...
                                                                const Text(' - '),
                                                                Text(value.newOrderList[index].orders![orderIndex].variations![0].items![value.newOrderList[index].orders![orderIndex].variant].title.toString(),
                                                                    style: const TextStyle(fontSize: 10, fontFamily: 'regular')),
                                                                const Text(' - '),
                                                                value.newOrderList[index].orders![orderIndex].variations![0].items![value.newOrderList[index].orders![orderIndex].variant].discount! > 0
                                                                    ? value.currencySide == 'left'
                                                                        ? Text(
                                                                            value.currencySymbol +
                                                                                value.newOrderList[index].orders![orderIndex].variations![0].items![value.newOrderList[index].orders![orderIndex].variant].sellPrice.toString(),
                                                                            style: const TextStyle(fontSize: 10, fontFamily: 'regular'))
                                                                        : Text(
                                                                            value.newOrderList[index].orders![orderIndex].variations![0].items![value.newOrderList[index].orders![orderIndex].variant].sellPrice.toString() +
                                                                                value.currencySymbol,
                                                                    ...
                                                                    : value.currencySide == 'left'
                                                                        ? Text(
                                                                            value.currencySymbol +
                                                                                value.newOrderList[index].orders![orderIndex].variations![0].items![value.newOrderList[index].orders![orderIndex].variant].price.toString(),
                                                                            style: const TextStyle(fontSize: 10, fontFamily: 'regular'))
                                                                        : Text(
                                                                            value.newOrderList[index].orders![orderIndex].variations![0].items![value.newOrderList[index].orders![orderIndex].variant].price.toString() +
                                                                                value.currencySymbol,
                                                      ...
                                                      children: value.olderOrderList[index].orders![orderIndex].variations == null
                                                          ? [
                                                              ...
                                                              if (value.olderOrderList[index].orders![orderIndex].haveGram == 1)
                                                                Text('${value.olderOrderList[index].orders![orderIndex].gram} ${'grams'.tr}', style: const TextStyle(fontSize: 10, fontFamily: 'regular'), textAlign: TextAlign.start)
                                                              else if (value.olderOrderList[index].orders![orderIndex].haveKg == 1)
                                                                Text('${value.olderOrderList[index].orders![orderIndex].kg} ${'kg'.tr}', style: const TextStyle(fontSize: 10, fontFamily: 'regular'), textAlign: TextAlign.start)
                                                              else if (value.olderOrderList[index].orders![orderIndex].haveLiter == 1)
                                                                Text('${value.olderOrderList[index].orders![orderIndex].liter} ${'ltr'.tr}', style: const TextStyle(fontSize: 10, fontFamily: 'regular'), textAlign: TextAlign.start)
                                                              else if (value.olderOrderList[index].orders![orderIndex].haveMl == 1)
                                                                Text('${value.olderOrderList[index].orders![orderIndex].ml} ${'ml'.tr}', style: const TextStyle(fontSize: 10, fontFamily: 'regular'), textAlign: TextAlign.start)
                                                              else if (value.olderOrderList[index].orders![orderIndex].havePcs == 1)
                                                                Text('${value.olderOrderList[index].orders![orderIndex].pcs} ${'pcs'.tr}', style: const TextStyle(fontSize: 10, fontFamily: 'regular'), textAlign: TextAlign.start),
                                                              const Text(' - '),
                                                              value.olderOrderList[index].orders![orderIndex].discount! > 0
                                                                  ? value.currencySide == 'left'
                                                                      ? Text(value.currencySymbol + value.olderOrderList[index].orders![orderIndex].sellPrice.toString(), style: const TextStyle(fontSize: 10, fontFamily: 'regular'))
                                                                      : Text(value.olderOrderList[index].orders![orderIndex].sellPrice.toString() + value.currencySymbol, style: const TextStyle(fontSize: 10, fontFamily: 'regular'))
                                                                  : value.currencySide == 'left'
                                                          ...
                                                          : [
                                                              ...
                                                              const Text(' - '),
                                                              Text(value.olderOrderList[index].orders![orderIndex].variations![0].items![value.olderOrderList[index].orders![orderIndex].variant].title.toString(),
                                                                  style: const TextStyle(fontSize: 10, fontFamily: 'regular')),
                                                              const Text(' - '),
                                                              value.olderOrderList[index].orders![orderIndex].variations![0].items![value.olderOrderList[index].orders![orderIndex].variant].discount! > 0
                                                                  ? value.currencySide == 'left'
                                                                      ? Text(
                                                                          value.currencySymbol +
                                                                              value.olderOrderList[index].orders![orderIndex].variations![0].items![value.olderOrderList[index].orders![orderIndex].variant].discount.toString(),
                                                                          style: const TextStyle(fontSize: 10, fontFamily: 'regular'))
                                                                      : Text(
                                                                          value.olderOrderList[index].orders![orderIndex].variations![0].items![value.olderOrderList[index].orders![orderIndex].variant].discount.toString() +
                                                                              value.currencySymbol,
                                                                  ...
                                                                  : value.currencySide == 'left'
                                                                      ? Text(
                                                                          value.currencySymbol +
                                                                              value.olderOrderList[index].orders![orderIndex].variations![0].items![value.olderOrderList[index].orders![orderIndex].variant].price.toString(),
                                                                          style: const TextStyle(fontSize: 10, fontFamily: 'regular'))
                                                                      : Text(
                                                                          value.olderOrderList[index].orders![orderIndex].variations![0].items![value.olderOrderList[index].orders![orderIndex].variant].price.toString() +
                                                                              value.currencySymbol,
