                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: ElevatedButton(
                                        ...
                                        style: ElevatedButton.styleFrom(foregroundColor: ThemeProvider.whiteColor, backgroundColor: ThemeProvider.appColor, elevation: 0),
                                        child: value.isLogin.value == true ? const CircularProgressIndicator(color: ThemeProvider.whiteColor) : Text('Continue'.tr, style: const TextStyle(fontFamily: 'regular', fontSize: 16)),
                                      ),
                                    ),
                                  ],
                                ),
