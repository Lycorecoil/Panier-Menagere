...
export class ApiService {
  ...
  public createStipeToken(body: any, secret: any): Promise<any> {
    return new Promise<any>((resolve, reject) => {
      const header = {
        headers: new HttpHeaders()
          .set('Content-Type', 'application/x-www-form-urlencoded')
      ...
      const param = this.JSON_to_URLEncoded(body);
      console.log(param);
      this.http.post('https://api.stripe.com/v1/tokens', param, header).subscribe((data) => {
        resolve(data);
      }, error => {
        reject(error);
      });
  ...
  public addStripeCards(body: any, secret: any, id: any): Promise<any> {
    return new Promise<any>((resolve, reject) => {
      const header = {
        headers: new HttpHeaders()
          .set('Content-Type', 'application/x-www-form-urlencoded')
      ...
      const param = this.JSON_to_URLEncoded(body);
      console.log(param);
      this.http.post('https://api.stripe.com/v1/customers/' + id, param, header).subscribe((data) => {
        resolve(data);
      }, error => {
        reject(error);
      });
  ...
  public getStripeCards(secret: any, id: any): Promise<any> {
    return new Promise<any>((resolve, reject) => {
      const header = {
        headers: new HttpHeaders()
          .set('Content-Type', 'application/x-www-form-urlencoded')
      ...
      this.http.get('https://api.stripe.com/v1/customers/' + id + '/sources', header).subscribe((data) => {
        resolve(data);
      }, error => {
        reject(error);
      });
  ...
  public createStripePayments(body: any, secret: any): Promise<any> {
    return new Promise<any>((resolve, reject) => {
      const header = {
        headers: new HttpHeaders()
          .set('Content-Type', 'application/x-www-form-urlencoded')
      ...
      const param = this.JSON_to_URLEncoded(body);
      console.log(param);
      this.http.post('https://api.stripe.com/v1/charges', param, header).subscribe((data) => {
        resolve(data);
      }, error => {
        reject(error);
      });
  ...
  public createCustomer(body: any, secret: any): Promise<any> {
    return new Promise<any>((resolve, reject) => {
      const header = {
        headers: new HttpHeaders()
          .set('Content-Type', 'application/x-www-form-urlencoded')
      ...
      const param = this.JSON_to_URLEncoded(body);
      console.log(param);
      this.http.post('https://api.stripe.com/v1/customers', param, header).subscribe((data) => {
        resolve(data);
      }, error => {
        reject(error);
      });
